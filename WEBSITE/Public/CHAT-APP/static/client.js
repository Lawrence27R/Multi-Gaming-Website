...
$(function () {
    ...
    socket.on('addChatMessage(server->clients)', function (usernameAndMsg) {
        ...
        let bkg = (username_adding_msg === socket.username) ? "#99ff99" : "#ccebff";
        let position = (username_adding_msg === socket.username) ? "right" : "left";
        let msg_with_style = `<div class="padd ${position}" ><span class="msg_border" style="background: ` + bkg + `">` + msg + `</span></div>`;
